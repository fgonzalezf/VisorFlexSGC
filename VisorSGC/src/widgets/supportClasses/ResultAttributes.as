...
public class ResultAttributes
{
    ...
    public static function toResultAttributes(fields:XMLList,
											  ...
											  //fgonzalez
											  linkField2:String = null,
                                              linkAlias:String = null,
											  //fgonzalez
											  linkAlias2:String = null):ResultAttributes
    {
		...
		resultAttributes.link2 = link2 ? link2 : null;
		resultAttributes.linkAlias2 = linkAlias2;
        ...
        function displayFields(fieldName:String, fieldXML:XML, field:Field):void
        {
			...
			else if (linkField2 && upperCaseFieldName == linkField2.toUpperCase())
			{
				link2 = value;
				linkAlias2 = linkAlias2;
			}
            else
            {
